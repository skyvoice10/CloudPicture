...
public class GetImageFirstUrlApi {
    ...
    public static void main(String[] args){
        //  测试以图搜图功能
        String url="https://graph.baidu.com/s?card_key=&entrance=GENERAL&extUiData[isLogoShow]=1&f=all&isLogoShow=1&session_id=14030732451056532780&sign=121a112b4c44f7ecf44f201770217019&tpl_from=pc";
        String imagePageUrl = getImageFirstUrl(url);
