  ...
  <div id="SpaceManagePage">
    <a-flex justify="space-between">
      ...
      <a-space>
        ...
        <a-button href="/space_analyze?queryPublic=1" target="_blank">分析公共空间</a-button>
      </a-space>
    </a-flex>
    ...
    <a-form layout="inline" :model="searchParams" @finish="doSearch">
      ...
      <a-form-item name="spacceLevel" label="空间级别">
        <a-select
...
import { listSpacePageUsingPost, deleteSpaceUsingPost } from '@/api/SpaceController'
...
const fetchData = async () => {
  const res = await listSpacePageUsingPost({
    ...searchParams,
  })
