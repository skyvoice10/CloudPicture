      ...
      <a-col :sm="24" :md="8" :xl="6">
        <a-card title="图片信息">
          ...
          <a-space wrap>
            ...
            <a-button type="primary" :icon="h(ShareAltOutlined)" @click="doShare" ghost
              >分享</a-button
            >
            <a-button v-if="canEdit" type="default" :icon="h(EditOutlined)" @click="doEdit"
              >编辑</a-button
            >
            <a-button v-if="canEdit" danger :icon="h(DeleteOutlined)" @click="doDelete"
              >删除</a-button
            >
          </a-space>
        </a-card>
